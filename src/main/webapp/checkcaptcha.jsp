...
<%
    ...
    String secretKey = "6LfOlQAVAAAAAEcyCMJeqGg-maj26VqnEWShwTAU";
    ...
    try {
        ...
        errorcode = (String)jsonObj.get("error-code");
        hostname = (String)jsonObj.get("hostname");

        score = (String)jsonObj.get("score");
